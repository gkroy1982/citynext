...
-- Generation Time: Jun 07, 2015 at 11:05 PM
...
(3, 28, '', 'sdf', 10, '2014-12-15', 1, 'Active', '2014-12-04 05:55:59'),
...
(1, 2, 28, 'test', 'test', '1842015134237-Chrysanthemum.jpg', '2015-04-04', '2015-05-15', '2015-04-18 11:42:37', 'Active');
...
(51, 'MUSICAL  INSTRUMENTS', '', '28420151320-'),
...
(32, 6, 'School & College ', '', '112201562735-'),
...
(36, 25, 'Birthday & Kitty Parties', '', '112201563822-'),
(37, 25, 'Ring Ceremony, Wedding Receptions, etc.', '', '112201563910-'),
...
(45, 10, 'Street Vendors', '', '112201564734-'),
...
(99, 6, 'Others', '', '1322015164641-'),
(100, 15, 'Others', '', '1322015164713-'),
(101, 25, 'Others', '', '1322015164748-'),
(102, 29, 'Others', '', '1322015164846-'),
(103, 20, 'Others', '', '1322015164925-'),
(104, 10, 'Others', '', '1322015165120-'),
(105, 17, 'Others', '', '1322015165143-'),
...
(28, 2, 'salman', 'khan', 'Salman Khan', 30, 'seller@gmail.com', 'seller', 1, 'kk', '184201510451-images34.jpg', 'bbbbbbbbb', 'Job', 'bbbbbbbbbb', 'bbbbbb', '5675676575', 'bbbbbbbb', 2, 1, 23231, 1, 'Active', 0, '', '2015-01-24 07:48:09'),
...
(36, 1, 'avantika ', 'agarwal', 'Avantika  Agarwal', 35, 'abhinavabhi2603@gmail.com', '12345', 1, 'O.P.Agarwal', '2142015103914-20150406_185635.jpg', '', 'Housewife', '', '128 sadar bazar', '9235565001', '', 2, 66, 284001, 38, 'Active', 0, '', '2015-02-04 05:54:21'),
...
ALTER TABLE `ads_history`
 ADD PRIMARY KEY (`id`), ADD KEY `ads_id` (`ads_id`), ADD KEY `user_id` (`user_id`);
...
--
ALTER TABLE `card`
 ADD PRIMARY KEY (`cid`), ADD KEY `users_id` (`users_id`), ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `career`
--
ALTER TABLE `career`
 ADD PRIMARY KEY (`cid`), ADD KEY `career_id` (`career_id`);
...
--
ALTER TABLE `city`
 ADD PRIMARY KEY (`cid`), ADD KEY `state_id` (`state_id`);
...
ALTER TABLE `classifieds`
 ADD PRIMARY KEY (`id`), ADD KEY `classified_id` (`classified_id`), ADD KEY `user_id` (`user_id`);
...
ALTER TABLE `products`
 ADD PRIMARY KEY (`pid`), ADD KEY `sub_category_id` (`sub_category_id`,`version_id`), ADD KEY `version_id` (`version_id`), ADD KEY `user_id` (`user_id`,`main_category_id`), ADD KEY `main_category_id` (`main_category_id`), ADD KEY `user_id_2` (`user_id`);
...
ALTER TABLE `product_offers`
 ADD PRIMARY KEY (`poid`), ADD KEY `offer_id` (`offer_id`), ADD KEY `user_id` (`user_id`), ADD KEY `product_id` (`product_id`);
...
ALTER TABLE `sub_category`
 ADD PRIMARY KEY (`scid`), ADD KEY `main_category_id` (`main_category_id`);

--
-- Indexes for table `user`
--
ALTER TABLE `user`
 ADD PRIMARY KEY (`userId`), ADD KEY `firstName` (`firstName`);

--
-- Indexes for table `users`
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`uid`), ADD KEY `location_area` (`area_id`), ADD KEY `location_area_2` (`area_id`), ADD KEY `question_id` (`question_id`);
...
--
ALTER TABLE `main_category`
MODIFY `mcid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=56;
--
...
--
ALTER TABLE `sub_category`
MODIFY `scid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=164;
--
