...
-- Generation Time: Aug 13, 2015 at 02:43 PM
...
(10, 37, '197201518278-2011-10-26 19.42.10.jpg', 'liiuyioiojh', 77777777, '0000-00-00', 1, 'Active', '2015-07-19 18:27:08');
...
(1, 28, 'Air India inducts 534 cabin crew till May 1: Sharma', ' Air India has selected a total of 534 candidates to induct them into the airline as part of its plan to hire 800 additional cabin staff, minister of state for civil aviation Mahesh Sharma said in Raj', '482015163655-Air-India.jpg', '2015-04-20', '2015-04-18 11:49:27', 'Active'),
(2, 36, 'Attention', 'stuuiyiouyoi ghjhkjlkjl hnghjjyki cghjgjhgkjhkhk bhkjhjkljlkjl hlkjlkjlkjl; kjhkljlj;l hkjhlkkllk nhlkjljljlj j,kjljl;kjl.kj', '95201551833-Jellyfish.jpg', '0000-00-00', '2015-05-09 05:18:33', 'Active'),
(3, 34, 'plantation for green jhansi', '500 plants were planted by the ABC NGO at Sadar Bazar Jhansi\r\nhkljkljklj  jljlkjl;j jnkljljlkjl nkljkljlkj nknjkljlkj jl;jgfghfhjgkj nkljlk;lk ikjkljlkl. iljljkljlkjkljn hnlkhggjhj kljlkjlkjlkj jnkljlk', '882015175251-Tulips.jpg', '2015-08-08', '2015-08-08 17:01:35', 'Active');
...
(21, 'hihkhbkffghk', 444444444444, 'hklchkjfhik@hjkgjfhg.fff', 'gjgkjjhlkj;lkghcb  \r\nkjgjfjhbknl', 'read', '2015-04-06 03:06:16'),
(22, 'Gk', 8308992045, 'gkroy1982@gmail.com', 'testing.......', 'unread', '2015-07-29 18:37:45');
...
(6, 'goutam', 8308992045, 'gkroy1982@gmail.com', 'testing....', 'read', '2015-07-29 18:34:00');
...
(37, 36, 1, 8090221150, 'Hi Avantika ,Your discount voucher is 721408, Please contact abhinav agarwal civil lines 9235565001. ', '2015-07-13 18:03:22'),
(38, 34, 1, 9235565001, 'Hi Abhinav,Discount Voucher no is 721408 Request By Avantika  Mobile No 8090221150', '2015-07-13 18:03:23'),
(39, 37, 1, 8056256705, 'Dear Manjree,fdkl;jvf;lkjk;ljlf fgnk;ljl;ifg kkjlkjlk kljlkjl.Your voucher code is 721408, valid upto 01-01-1970. Kindly show this massage at Hot Bite, 9235565001 and avail your offer.', '2015-07-17 13:58:03'),
(40, 34, 1, 9235565001, 'Dear Sir/Madam, Your Discount Voucher Code is 721408 has been received by Manjree, 08056256705.', '2015-07-17 13:58:03');
...
--
-- Table structure for table `main_category_used`
--

CREATE TABLE IF NOT EXISTS `main_category_used` (
  `mcid` int(11) NOT NULL,
  `category` varchar(200) NOT NULL,
  `description` text NOT NULL,
  `icon` varchar(200) NOT NULL
...
--
-- Dumping data for table `main_category_used`
--

INSERT INTO `main_category_used` (`mcid`, `category`, `description`, `icon`) VALUES
(7, 'TOURS & TRAVELS', '', '194201572112-travels.png'),
(8, 'REAL ESTATE', '', '194201572137-real-estate.png'),
(9, 'HOME & OFFICE', '', '19420157225-office.png'),
(15, 'ELECTRICALS & ELECTRONICS', '', '194201572857-electronic repair.png'),
...
(4, 28, 18, 0, 0, 'book', '297201564851-Desert.jpg', '297201564851-', '297201564851-', '300', 1, '<p>book</p>', 0, '2015-07-29 06:48:51', 'Active'),
(5, 28, 18, 0, 0, 'All Yours, Stranger (English)', '297201517385-all-yours-stranger-400x400-imae8ugznzzzvjs8.jpeg', '2972015173723-', '2972015173723-', '135', 1, '<div class="description specSection">\r\n<h3 class="sectionTitle">All Yours, Stranger (English) (Paperback) Price: Rs. 135</h3>\r\n<div class="description-text">For those of you who dont know me yet, Im Rivanah Bannerjee, a Kolkatan trying to find her footing in Mumbai. Even though Im currently in a relationship with a great guy, I cant help but miss my ex-boyfriend despite knowing that he cheated on me. But thats the least of my worries. The stranger has gone missing since the police tried to nab him unsuccessfully. Where is he? What does he want from me? Why did he come into my life in the first place? Will he ever contact me again? These and many more questions continue to torment me every day. Im desperate for the stranger to come back to me knowing full well that he may destroy me forever. But then thats the sexiest thing I have ever known about someone. With every revelation, it seems the truth is far more twisted than Rivanah can imagine. Wickedly plotted, All Yours, Stranger - Novoneel Chakrabortys gripping follow-up to his hugely popular Marry Me, Stranger-will keep you on the edge of your seat until the last page. Book two of the Stranger trilogy<br /><br /><strong>About the Author<br /><br />Novoneel Chakraborty</strong> is the author of five bestselling romantic thriller novels. He works in Indian television and films and lives in Mumbai.</div>\r\n</div>', 0, '2015-07-29 17:37:23', 'Active'),
(6, 34, 15, 0, 0, 'laptop', '48201524240-2015-03-18 10.05.15.jpg', '48201524240-', '48201524240-', '5000', 1, '<p style="text-align: left;">hjgfhjhkjlkjl hkjhkljlkjl. ,njlkjl;kjl;k;l jl;jl;kj;lk;l lkjl;k;lk;lkp;</p>', 0, '2015-08-04 02:42:40', 'Inactive');
...
(21, 36, 11, 'Pending', '2015-07-13 18:03:22'),
(22, 37, 11, 'Pending', '2015-07-17 13:58:02');
...
--
-- Indexes for table `main_category_used`
--
ALTER TABLE `main_category_used`
  ADD PRIMARY KEY (`mcid`);
...
--
-- AUTO_INCREMENT for table `main_category_used`
--
ALTER TABLE `main_category_used`
  MODIFY `mcid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=58;
--
