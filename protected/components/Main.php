...
Class Main  {
	...
	public static function adminmenu($default = null){
		...
		if(!Yii::app()->user->isGuest){
			$menu[]=array('label'=>"Services", 'url'=>array('/site/index'));
			$menu[]=array('label'=>"category", 'url'=>array('/site/index'));
			$menu[]=array('label'=>"Packages", 'url'=>array('/site/index'));
			$menu[]=array('label'=>"Gallery", 'url'=>array('/site/login'));
