...
class SiteController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$max_slide_limit=$slide_limit->slide_limit;
		...
		$this->render('index',array('products'=>$products, 'ads'=>$ads, 'ads2'=>$ads2, 'news'=>$news, 'company_ads'=>$company_ads ) );
	}
	...
	public function actionCondolences()
	{
		...
		$nav="<a href='". Yii::app()->createUrl('site/index')."'>Home</a> » <a>Obituries</a>";
		
		$Condolences = Condolences::model()->findAll(array('condition'=>"'$todate'>=date AND '$todate'<=DATE_ADD(date,INTERVAL 3 DAY) "));
