...
class SaleController extends Controller
{
	...
	public function actionProducts($id)
	{
		...
		$nav="<a href='".Yii::app()->createUrl('sale/subcategories',array('id'=>$subcat->main_category_id))."'>".$subcat->mainCategory->category .'</a> >> <a href="#">'.$subcat->sub_category.'</a>';

		$model = Product::model()->findAll( array('condition'=>'sub_category_id='.$id));
	...
	{	
		...
		$this->render('sell',array('categories'=>$categories, 'ads'=>$ads) );
		//$this->render('sell');
	}
