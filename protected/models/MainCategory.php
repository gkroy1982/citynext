 ...
 *
 * The followings are the available columns in table 'main_category':
 * @property integer $mcid
...
class MainCategory extends CActiveRecord
{
	...
	public static function getMainCategory() {
		return CHtml::listData(Maincategory::model()->findAll(array("order"=>"category")),'mcid', 'category');
	}
}
