...
class Product extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, main_category_id, product, price, description, quantity', 'required'),
			array('user_id, main_category_id, sub_category_id, quantity, rating', 'numerical', 'integerOnly'=>true),
			array('product, price,status', 'length', 'max'=>200),
			...
			array('pid, user_id, main_category_id, sub_category_id, version_id, product, image,image2,image3, price, quantity, description, rating,status, created_on, activation_date', 'safe'),
			array('pid, user_id, main_category_id, sub_category_id, version_id, product, image,image2,image3, price, quantity, description, rating,status, created_on, activation_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'mainCategory' => array(self::BELONGS_TO, 'MainCategoryUsed', 'main_category_id'),
	...
	public static function getProducts() {
		return CHtml::listData(Product::model()->findAll(array('condition'=>'status="Active"',"order"=>"product")),'pid', 'product');
	}
