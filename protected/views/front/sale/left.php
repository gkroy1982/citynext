    ...
    <div class="box-heading">Services</div>
      ...
      <div class="box-content box-category">
          <ul id="custom_accordion1">
            <li class="category25"><a class="cuuchild " href="<?php echo Yii::app()->createUrl('site/buy')?>">I Want to Buy</a> </li>
            <li class="category18"><a class="cuuchild " href="<?php echo Yii::app()->createUrl('sale/sell')?>">I Want to Sell</a></li>                         
          </ul>
        </div>
        <br>
        ...
        <div class="box-content box-category">
          ...
          <?php                  
                ...
                {
                  ?>
                  <li class="category25"><span class="down"><a class="cuuchild " href="#"><?php echo ucwords($menu->category);?></a> </span>
                    <ul>
