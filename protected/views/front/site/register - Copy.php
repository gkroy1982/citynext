            ...
            <tbody>
              ...
              <tr id="company-id-display">
                ...
                <td><select name="country_id">
                    ...
                    <option value=" ">Whole Saler</option>
                     <option value=" ">Other</option>
                    </select>
                 </td>
              </tr>
              <tr id="company-id-display">
                <td><span class="required">*</span>Solution:</td>
                <td><input class="large-field" type="text" value="" name="company_id"></td>
              </tr>
               <tr>
                <td><span class="required">*</span> First Name:</td>
              ...
              <tr>
                ...
                <td><textarea rows="2" cols="35" class="large-field" type="text" value="" name="email"></textarea></td>
              </tr>
              ...
              <tr>
                <td> <span class="required">*</span> Primary Contact No:</td>
                 <td><input class="large-field" type="text" value="" name="fax"></td>
              </tr>
               <tr>
