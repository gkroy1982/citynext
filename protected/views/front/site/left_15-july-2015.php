    ...
    <div class="box-heading">Services</div>
      ...
      <div class="box-content box-category">
          <ul id="custom_accordion1">		  
            <li class="category25"><a class="cuuchild " href="#">Used Products</a> 
			...
			<li class="category25"><a class="cuuchild " href="<?php echo Yii::app()->createUrl('site/condolences')?>">Condolences</a> 
