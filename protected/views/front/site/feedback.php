	  ...
	  <div class="box">
		<div class="box-heading">
			<div class="breadcrumb"> 
				<a href="<?php echo Yii::app()->createUrl('site/index')?>">Home</a> » <a href="#">Feedback</a> 
			</div>
		</div>
	  </div>
...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 register-account">
		...
		<div class="page-content">
		  ...
		  <div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4">
			  <p> <?php echo $form->labelEx($model,'feedback'); ?> </p>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8">
				<?php echo $form->textArea($model,'feedback',array('row'=>6,'col'=>6,'class'=>'large-field','rows'=>'2','cols'=>'2' )); ?>
