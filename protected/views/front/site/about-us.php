<?php $this->pageTitle='Jhansishopping.com | About Us';?>
  <div id="container" class="content">
    ...
    <section class="main-content col-lg-9 col-md-9 col-sm-9 col-xs-12">
      <div id="content">
        ...
        <div class="breadcrumb"><a href="<?php echo Yii::app()->createUrl('site/index')?>">Home</a> » <a href="#">About Us</a></div>
        <!--Breadcrumb Part End-->
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="page-content">
              <!--<img class="align-left" src="img/about-us.jpg" alt="">-->
