 ...
 <?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-4">
			<p>
				<?php 
				echo $form->label($model,'classified_id'); 
				?>			
			</p>
		</div>
		<div class="col-lg-8 col-md-8 col-sm-8">
			<?php 
			// echo $form->textField($model,'classified_id'); 
			echo $form->dropDownList($model,'classified_id',Classifiedtype::getTypes(),array('empty'=>'-- select --'));  
			?>
		</div>
	</div>
	<!--div class="row">
	...
	<div class="row">
		...
		<div class="col-lg-8 col-md-8 col-sm-8">
			<?php 
			// echo $form->textField($model,'status',array('size'=>60,'maxlength'=>100));
			echo $form->dropDownList($model,'status',Products::getStatus());
			?>
		</div>	
	</div>
	<div class="row">
